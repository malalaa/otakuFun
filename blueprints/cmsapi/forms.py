from blueprints.front.forms import BaseForm
...
class AddBannerForm(BaseForm):
    ...
    link_url = StringField(validators=[InputRequired(message='请输入轮播图图片链接')])
    priority = IntegerField(validators=[InputRequired(message='请输入轮播图图片链接')])
